...
[https://grima.app.wrlc.org/Analytics/ia\_journal\_lookup.php?ISSN=](https://grima.app.wrlc.org/Analytics/ia_journal_lookup.php?ISSN=)
...
{% hint style="info" %}
This process continues with [steps for Monograph Acquisitions](../bindery/serials-binding-monoacq-steps.md)
{% endhint %}
